...
class CartTest extends Unit
{
    ...
    public function _before()
    {
        ...
        $this->testItems['adidas'] = $this->tester->haveInRepository(CartItem::class, ['product' => $adidas, 'quantity' => 1]);
        $nike = $this->em->find(Product::class, $this->testProducts['nike']);
        $this->testItems['nike'] = $this->tester->haveInRepository(CartItem::class, ['product' => $nike, 'quantity' => 1]);
    }
